...
<body>
    ...
    <main>
        ...
        <section id="about" style="display: flex; flex-direction: row; align-items:center">

            <div style="margin-right: 50px; align-items: center">
                <img src="/img/foto.jpg" alt="Serhii" class="avatar">
            </div>
    ...
    <footer>
        ...
        <a href="https://rs.school/courses/javascript-ru">
            <img src="/img/rs.png" alt="Course Logo">
        </a>
    </footer>
</body>
</html>
